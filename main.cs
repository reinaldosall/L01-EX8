...
class MainClass {
  public static void Main (string[] args) {
    /*
    8- Implemente um código em C# que leia um  número inteiro (assuma números com apenas três dígitos) e imprima a saída com as centenas, dezenas e unidades conforme o exemplo. Ex.: número lido 769Saída: 7 centenas –6 dezenas –9 unidades
    */
